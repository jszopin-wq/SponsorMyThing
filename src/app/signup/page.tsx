...
export default function SignUpPage() {
 ...
 <div className="absolute top-1/3 right-1/4 h-96 w-96 rounded-sm bg-purple-600/15 hidden" />
 <div className="absolute bottom-1/4 left-1/3 h-72 w-72 rounded-sm bg-brand-600/10 hidden" />
 </div>
