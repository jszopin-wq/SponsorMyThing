    ...
    return (
        <div className="min-h-screen bg-surface-950">
                ...
                <div className="mx-auto max-w-7xl px-6">
                    ...
                    <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        {steps.map((step, i) => (
                            ...
                            >
                                <div className={`mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${step.color}`}>
            ...
            <section className="border-t border-surface-800/50 py-24">
                <div className="mx-auto max-w-7xl px-6">
                    <div className="glass-card mx-auto max-w-3xl p-12 text-center animate-pulse-glow">
