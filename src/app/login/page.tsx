...
export default function LoginPage() {
 ...
 <div className="absolute top-1/3 left-1/3 h-96 w-96 rounded-sm bg-brand-600/15 hidden" />
 <div className="absolute bottom-1/3 right-1/3 h-72 w-72 rounded-sm bg-purple-600/10 hidden" />
 </div>
 ...
 <div className="flex h-10 w-10 items-center justify-center rounded-sm bg-va-dark ">
 ...
 className="flex w-full items-center justify-center gap-3 rounded-sm border border-surface-100 bg-surface-800/50 px-4 py-3 text-sm font-medium text-surface-200 transition-all hover:bg-surface-700/50 hover:border-surface-600"
 >
 ...
 {error && (
 <div className="rounded-sm bg-danger/10 px-4 py-2.5 text-sm text-red-400">
 {error}
 </div>
 )}
