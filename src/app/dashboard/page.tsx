...
export default async function DashboardPage() {
 ...
 {userIsAdmin && (
 <span className="inline-flex items-center gap-1 rounded-sm bg-amber-500/15 px-2.5 py-1 text-xs font-semibold text-amber-400 border border-amber-500/20">
 ...
 <div className="glass-card p-5">
 <div className="flex items-center gap-3">
 <div className="flex h-10 w-10 items-center justify-center rounded-sm bg-emerald-500/15">
 ...
 <div className="glass-card p-5">
 <div className="flex items-center gap-3">
 <div className="flex h-10 w-10 items-center justify-center rounded-sm bg-pink-500/15">
 ...
 <div className={`mb-4 inline-flex h-11 w-11 items-center justify-center rounded-sm bg-va-dark ${action.color}`}>
