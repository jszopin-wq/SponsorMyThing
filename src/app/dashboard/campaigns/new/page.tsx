...
export default function NewCampaignPage() {
 ...
 <div className="flex h-11 w-11 items-center justify-center rounded-sm bg-va-dark ">
 ...
 className={`rounded-sm border p-4 text-left transition-all ${campaignType === type.value
 ? "border-brand-500 bg-brand-500/10"
 : "border-surface-100 bg-surface-900/30 hover:border-surface-600"
 }`}
 >
 ...
 {error && (
 <div className="rounded-sm bg-danger/10 px-4 py-2.5 text-sm text-red-400">{error}</div>
 )}
